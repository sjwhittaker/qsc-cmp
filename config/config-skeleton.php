...
define("QSC_CMP_LEGACY_COURSE_DIRECTORY_LINK", QSC_CMP_COURSE_DIRECTORY_LINK."/legacy");
...
include_once(QSC_CMP_SRC_DATABASE_OBJECTS_DIRECTORY_PATH.'/CLLOAndCourseAndLevel.php');
...
include_once(QSC_CMP_SRC_DATABASE_OBJECTS_DIRECTORY_PATH.'/CLLOLevel.php');
include_once(QSC_CMP_SRC_DATABASE_OBJECTS_DIRECTORY_PATH.'/Course.php');
include_once(QSC_CMP_SRC_DATABASE_OBJECTS_DIRECTORY_PATH.'/CourseAndCLLOLevel.php');
...
include_once(QSC_CMP_SRC_DATABASE_OBJECTS_DIRECTORY_PATH.'/LegacyCourseEntry.php');
