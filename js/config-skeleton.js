...
const QSC_CMP_AJAX_ACTION_SEARCH_PLANS_FOR_PLLOS = "searchPlansForPLLOs";
...
const QSC_CMP_AJAX_ACTION_GET_PLLOS_FOR_COURSE = "getPLLOsForCourse";
const QSC_CMP_AJAX_ACTION_GET_PLLOS_FOR_SEVERAL_COURSES = "getPLLOsForSeveralCourses";
const QSC_CMP_AJAX_ACTION_GET_PLLO_FROM_ID = "getPLLOFromID";
const QSC_CMP_AJAX_ACTION_GET_PLLOS_FOR_PLAN = "getPLLOsForPlan";
const QSC_CMP_AJAX_ACTION_GET_PLLOS_FOR_PLANS = "getPLLOsForPlans";
